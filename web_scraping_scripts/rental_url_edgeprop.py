...
class RentalURLs:
    """
    Format: https://www.edgeprop.my/rent/malaysia/{property_type}? -> any filter done after this
    search_bar = "keyword="
    """
    def __init__(self, base_url, property_type, listing_type):
        self._base_url = base_url
        self._search_bar = 'keyword='
    ...
    @property
    def url(self):
        return (self.base_url + self.listing_type + self.extension + self.property_type + self.search_bar)
